   ...
   public class MessagesController: ControllerBase
    {
        ...
        public MessagesController(IProfilesRepository repo, IMapper mapper)
        {
            this._repo = repo;
            this._mapper = mapper;
        }
        ...
        public async Task<IActionResult> CreateMessage(int userId, MessageForCreationDTO messageForCreation)        
        {
            ...
            var recipient = await this._repo.GetUser(messageForCreation.RecipientId);

            if (recipient == null)
                return BadRequest("Could not find user");

            var message = this._mapper.Map<Message>(messageForCreation);
